...
function (_Component) {
  ...
  function Provider(props) {
    ...
    _this.pubSub.on('enableSyncRendering', function (enableSyncRendering) {
      return _this.setStateInConstructor({
        enableSyncRendering: enableSyncRendering
      });
    });
    ...
    (0, _googletag.enableSyncRendering)(_this.props.enableSyncRendering);
...
Provider.propTypes = {
  ...
  enableSyncRendering: _propTypes.default.bool,
