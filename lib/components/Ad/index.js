...
function (_Component) {
  ...
  function Ad(_props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setTargeting", _this.cmdPush(function () {
      return R.toPairs(_this.props.targeting).map(function (_ref) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getAdDimensions", function () {
      var size = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
        width: _this.props.size[0],
        height: _this.props.size[1]
      };
      var sizeMap = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _this.props.sizeMapping;
      var wWidth = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : window.innerWidth;
      return sizeMap.sort(function (a, b) {
        return a.viewPort[0] < b.viewPort[0] ? -1 : 1;
      }).reduce(function (acc, _ref4) {
        var _ref4$viewPort = _slicedToArray(_ref4.viewPort, 1),
            vWidth = _ref4$viewPort[0],
            _ref4$slots = _slicedToArray(_ref4.slots, 2),
            width = _ref4$slots[0],
            height = _ref4$slots[1];

        return wWidth >= vWidth ? {
          width: width,
          height: height
        } : acc;
      }, {
  ...
  _createClass(Ad, [{
    ...
    value: function componentDidMount() {
      this.defineSlot(); // event start

      this.slotOnload();
      this.slotRenderEnded();
      this.impressionViewable();
      this.slotVisibilityChanged(); // events end
