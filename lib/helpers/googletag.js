...
exports.createGoogleTagEvents = exports.enableServices = exports.getVersion = exports.collapseEmptyDivs = exports.enableVideoAds = exports.enableSyncRendering = exports.enableAsyncRendering = exports.setCentering = exports.enableLazyLoad = exports.disableInitialLoad = exports.enableSingleRequest = exports.startGoogleTagQue = exports.createGPTScript = void 0;
...
var enableSyncRendering = function enableSyncRendering() {
  var isEnabled = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
  if (!isEnabled) return;
  window.googletag.cmd.push(function () {
...
exports.enableSyncRendering = enableSyncRendering;
...
var createGoogleTagEvents = function createGoogleTagEvents(pubSub) {
  ...
  window.googletag.cmd.push(function () {
    ...
    var fns = [{
      ...
      events: ['defineSlot', 'destroySlots', 'display']
    }, {
      ref: window.googletag.pubads(),
      events: ['disableInitialLoad', 'enableAsyncRendering', 'enableSyncRendering', 'enableLazyLoad', 'enableSingleRequest', 'enableVideoAds', 'setCentering', 'collapseEmptyDivs', 'getVersion', 'refresh', 'enableServices']
    }];
