...
function (_Component) {
  ...
  function VideoPlayer(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(VideoPlayer).call(this, props)); // Do not run when SSR.

    _defineProperty(_assertThisInitialized(_this), "loadPlayer", function (adTagUrl) {
    ...
    _defineProperty(_assertThisInitialized(_this), "refreshWhenVisible", function () {
    ...
    _this.refreshWhenVisible = _this.refreshWhenVisible.bind(_assertThisInitialized(_this));
    return _this;
  }
  /**
